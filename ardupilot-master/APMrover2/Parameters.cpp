...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    AP_SUBGROUPINFO(oa, "OA_", 45, ParametersG2, AP_OAPathPlanner),
     ...
     //golf
	 AP_GROUPINFO("GOLF_START_HOUR", 46, ParametersG2, regular_start_time_hour, 0),
	 AP_GROUPINFO("GOLF_START_MIN", 47, ParametersG2, regular_start_time_min, 0),
	 AP_GROUPINFO("GOLF_START_SEC", 48, ParametersG2, regular_start_time_sec, 0),
   //AP_GROUPINFO("GOLF_START__MS", 49, ParametersG2, regular_start_time_ms, 0),


	 AP_GROUPINFO("GOLF_END_HOUR", 50, ParametersG2, regular_end_time_hour, 0),
	 AP_GROUPINFO("GOLF_END_MIN", 51, ParametersG2, regular_end_time_min, 0),
	 AP_GROUPINFO("GOLF_END_SEC", 52, ParametersG2, regular_end_time_sec, 0),
   //AP_GROUPINFO("GOLF_END_MS", 53, ParametersG2, regular_end_time_ms, 0),
