...
public:
    ...
    //regular time
    AP_Int16     regular_start_time_hour;
    AP_Int16     regular_start_time_min;
    AP_Int16     regular_start_time_sec;
  //AP_Int16     regular_start_time_ms;

    AP_Int16     regular_end_time_hour;
    AP_Int16     regular_end_time_min;
    AP_Int16     regular_end_time_sec;
 // AP_Int16     regular_end_time_ms;
    //golf
};
